...
* The original package name 'com.testtasks.hacken.transactions-gateway' is invalid and this project uses 'com.testtasks.hacken.transactions_gateway' instead.
...
```
$ docker run --rm transactions-gateway:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/transactions-gateway
```
